...
fonte_canonical: operator_context/templates/SYMBOL_ENTRY_TEMPLATE.md
...
linked_people_real: []
  ...
  # SEMPRE manter tensão: pessoa real ≠ figura onírica ≠ função simbólica.
...
*Template de uso interno da skill dream-analysis. Copiar para SYMBOL_REGISTRY.md — não editar este arquivo. Fonte canonical: operator_context/templates/SYMBOL_ENTRY_TEMPLATE.md*
