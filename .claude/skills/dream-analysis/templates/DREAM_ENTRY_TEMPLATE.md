...
fonte_canonical: operator_context/templates/DREAM_ENTRY_TEMPLATE.md
...
places: []
  # Lugares do sonho. Incluir se real (ex: "Araxá — real") ou transposição.
...
4. `high_sensitivity` obrigatório para: conteúdo sexual explícito, violência intensa, numinoso extremo, pessoa real em contexto de assimetria etária.
...
*Template de uso interno da skill dream-analysis. Copiar para DREAM_REGISTRY.md — não editar este arquivo. Fonte canonical: operator_context/templates/DREAM_ENTRY_TEMPLATE.md*
