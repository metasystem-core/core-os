---
name: local-watchdog
description: Watchdog local do core ASSET-CORE. LÃª dinamicamente o SKILL.md deste core para extrair pontos de falha e monitorar deriva interna. NÃ£o replica conteÃºdo â€” lÃª na fonte. Ativo sempre que este core estÃ¡ em operaÃ§Ã£o.
status: active
layer: watchdog-local
---

# LOCAL-WATCHDOG â€” ASSET-CORE
...
```
âš  ASSET-CORE watchdog: [descriÃ§Ã£o do que foi detectado]
```

### Deriva grave ou violaÃ§Ã£o de firewall:
```
ðŸ”´ ASSET-CORE watchdog: operaÃ§Ã£o bloqueada.
[descriÃ§Ã£o]
...
```
âš¡ Watchdog local ASSET-CORE: violaÃ§Ã£o detectada alÃ©m do escopo local.
[descriÃ§Ã£o]
...
2. Substitua `ASSET-CORE` pelo nome do core
