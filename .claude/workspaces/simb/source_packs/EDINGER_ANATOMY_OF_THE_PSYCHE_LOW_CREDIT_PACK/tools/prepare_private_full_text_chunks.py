...
def clean_text(txt: str) -> str:
    ...
    # Collapse 3+ newlines
    txt = re.sub(r"\n{3,}", "\n\n", txt)
    # Remove running headers/footers that are pure numbers
...
def main() -> None:
    ...
    ap.add_argument(
        "--out",
        default=".claude/workspaces/simb/private_full_text_chunks/edinger_anatomy_of_the_psyche",
    ...
    # Protect output directory from accidental git staging
    ...
    if args.chapter_map:
        ...
        # Fallback: whole book as single section
